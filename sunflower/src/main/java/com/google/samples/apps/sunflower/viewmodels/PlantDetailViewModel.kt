...
class PlantDetailViewModel(
    ...
    init {
         ...
         * true. */
        val gardenPlantingForPlant = gardenPlantingRepository.getGardenPlantingForPlant(contactId)
        isPlanted = gardenPlantingForPlant.map { it != null }

        plant = plantRepository.getPlant(contactId)
    }

    fun addPlantToGarden() {
        viewModelScope.launch {
            gardenPlantingRepository.createGardenPlanting(contactId)
        }
    }
}
