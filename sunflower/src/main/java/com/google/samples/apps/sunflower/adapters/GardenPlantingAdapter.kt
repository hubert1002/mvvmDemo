...
class GardenPlantingAdapter :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        getItem(position).let { plantings ->
            with(holder) {
                ...
                bind(createOnClickListener(plantings.plant.contactId), plantings)
            }
        }
    }
    ...
    private fun createOnClickListener(contactId: String): View.OnClickListener {
        return View.OnClickListener {
                val direction =
                        GardenFragmentDirections.actionGardenFragmentToPlantDetailFragment(contactId)
...
private class GardenPlantDiffCallback : DiffUtil.ItemCallback<PlantAndGardenPlantings>() {
    ...
    override fun areItemsTheSame(
        ...
        return oldItem.plant.contactId == newItem.plant.contactId
    }
